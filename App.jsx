...
import { Mail, ArrowUpRight, Box, Layers, Sparkles, Code2 } from "lucide-react";
...
export default function App() {
  ...
  const projects = [
    ...
    },
    {
      no: "03",
      title: "CODE.DRILL",
      type: "React / Practice Tool",
      desc: "C言語とJavaの演習ターミナル。80問の問題で弱点を可視化する自作学習ツール。",
      tag: "WEB",
      icon: Code2,
      href: "/drill",  // ← ここを追加
    },
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-neutral-800">
            {projects.map((p) => {
              ...
              const href = p.href || "#";
              return (
                <a key={p.no} href={href} className="border-b border-neutral-800 px-2 md:px-4 py-10 grid grid-cols-12 gap-4 group hover:bg-neutral-900 transition cursor-pointer">
